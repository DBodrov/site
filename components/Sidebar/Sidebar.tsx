...
export function Sidebar() {
  return (
    <aside className={css.sidebar}>
      ...
      <div className={css.profile_pic__place}>
        ...
        <article className={css.description}>
          ...
          <span style={{textAlign: 'center'}}>Занимаюсь web разработкой более 15 лет</span>
          <div className={css.social}>
            <a href="https://hh.ru/resume/f970b994ff0afecb340039ed1f75466942764f">
              <Image
                src={hhIcon}
            ...
            <a href="https://github.com/DBodrov">
